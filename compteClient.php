    ...
    <div class="container emp-profile">
        <form method="post">
          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item">
                  <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Mes coordonnées bancaires</a>
              </li>
          </ul>
      </div>
  </div>
                        ...
                        if ($compte->num_rows > 0) {
                            ...
                            echo '<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">';
                            $numcard = $info['Num carte'];
                            $replacementChar = '*';
                            $limit = 4;
                            $replacementString = str_repeat($replacementChar, strlen($numcard) - $limit);

                            echo   '<p>' . substr_replace($numcard, $replacementString, $limit) . '</p>
                                            </div>
                                        </div>'; ?>
