...
<header>
    ...
    <main role="main">
      ...
      <div class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-4">
            <img class="rounded-circle" src="Images/Docteur F.svg" alt="Generic placeholder image" width="140" height="140">
          ...
          <div class="col-lg-4">
            <img class="rounded-circle" src="Images/Docteur H.svg" alt="Generic placeholder image" width="140" height="140">
            <h2>Lucas WEREY</h2>
